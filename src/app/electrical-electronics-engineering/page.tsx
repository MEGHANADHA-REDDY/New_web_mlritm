...
export default function ElectricalElectronicsEngineeringPage() {
  ...
  const sidebarItems = [
    { id: "home", name: "Department Home", href: "/electrical-electronics-engineering" },
    ...
    { id: "unique", name: "Unique @EEE", href: "#" },
    ...
    <div className="min-h-screen bg-background pt-40">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <DepartmentSidebar title="Electrical & Electronics" items={sidebarItems} />
          </motion.div>
