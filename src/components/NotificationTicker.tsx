...
export default function NotificationTicker({
   ...
   messages = [
    { text: "Admissions Open 2025 – Apply Now", url: "/admissions.pdf" },
    { text: "Placement Drive this week – Check the schedule", url: "/placements.pdf" },
    { text: "Research Symposium submissions close on 15 Oct", url: "/symposium.pdf" },
    { text: "Campus Fest coming soon – Stay tuned", url: "/campus-fest" },
  ],
  speedMs = 25000,
  className = "",
          ...
          <div className="whitespace-nowrap">
            ...
            >
              {items.map((msg, idx) => (
                ...
                {msg.url ? (
                <a href={msg.url} className="hover:underline" target="_blank">
                {msg.text}
                </a>
                ) : (
                <span>{msg.text}</span>
